...
import br.com.lucascm.mangaeasy.manga_easy_micro_api_config.service.TokenService
...
class SecurityConfig (
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        http.authorizeHttpRequests()
            .requestMatchers(HttpMethod.GET, "/v1/toggle/{id}").permitAll()
    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        ...
        configuration.allowedOrigins = listOf("http://localhost:3000", "http://localhost:80", "https://app.mangaeasy.online")
